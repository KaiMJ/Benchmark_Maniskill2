...
def process_images(image_paths, device="cuda:0", chunk_size=8192, mc_resolution=256, no_remove_bg=False, foreground_ratio=0.85, output_dir="output/", model_save_format="obj", render=False):
    timer = Timer()
...
# Example usage:
# process_images(['path/to/image1.jpg', 'path/to/image2.jpg'])
